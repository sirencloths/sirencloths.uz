...
type InventoryTransfer = {
  ...
  note?: string | null;
  createdAt: string;
  product?: Pick<Product, "id" | "title" | "slug" | "ean13">;
  variant?: Variant;
};
type CustomerRecord = {
