...
type StoreNotification = { id: string; title: Record<string, string>; text: Record<string, string>; imageUrl?: string; href?: string; createdAt: string; isActive?: boolean; clicks?: number; clickVisitorIds?: string[] };
type Variant = {
  id: string;
  sku: string;
  name: string;
