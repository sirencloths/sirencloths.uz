...
const common: Dictionary = {
  ...
  album: "Album: SIREN", articleTitle: "We need more skaters", allProducts: "All products", otherProducts: "Other products",
  ...
  close: "Close", remove: "Remove", selected: "Selected", cartEmpty: "Your cart is empty",
  freeDeliveryRemaining: "Until free delivery", freeDeliveryReached: "Free delivery", cartSubtotalWithCount: "Subtotal ({count})",
  removePromo: "Remove", promoAccepted: "Promo code accepted", promoCode: "Code", currency: "UZS",
  quickActions: "Quick actions", mobileNavigation: "Mobile navigation", email: "Email",
  favoritesTitle: "Favorites", favoritesEmpty: "There are no saved products yet", siteTesting: "SITE IS IN TESTING",
};

const translations: Record<Locale, Dictionary> & Record<string, Dictionary> = {
  en: common,
  uz: { ...common, shop: "Do'kon", collections: "Kolleksiyalar", lookbook: "Lukbuk", blog: "Blog", search: "Qidiruv", favorites: "Sevimlilar", cart: "Savat", profile: "Profil", newCollection: "Yangi kolleksiya", go: "O'tish", accessories: "Aksessuarlar", merch: "Merch", tactical: "Taktik", records: "Yozuvlar", playlist: "Pleylistga o'tish", readMore: "Davomini o'qish", customers: "Xaridorlarga", contacts: "Kontaktlar", payments: "To'lov turlari", delivery: "Yetkazib berish va to'lov", exchange: "Almashtirish va qaytarish", sizeGuide: "O'lchamlar jadvali", support: "Qo'llab-quvvatlash", privacy: "Maxfiylik siyosati", terms: "Foydalanish shartlari", language: "Til", confirm: "Tasdiqlash", location: "Toshkent", sale: "Yangi mahsulotlarga 20% chegirma", articleTitle: "Bizga ko'proq skeyterlar kerak", allProducts: "Barcha mahsulotlar", otherProducts: "Boshqa mahsulotlar", home: "Bosh sahifa", description: "Tavsif", notFound: "Mahsulot topilmadi", chooseColor: "Rangni tanlang", chooseSize: "O'lchamni tanlang", sizeHelp: "Mening o'lchamim qaysi?", addToCart: "Savatga qo'shish", goToCart: "Savatga o'tish", favoriteAdd: "Sevimlilarga qo'shish", freeDelivery: "2 000 000 so'mdan ortiq buyurtmalarga bepul yetkazib berish", darkGray: "To'q kulrang", black: "Qora", cream: "Krem", pink: "Pushti", classicTee: "Klassik futbolka", graphicPrint: "Old va orqadagi bosma grafika", cotton: "100% paxta", standardFit: "Standart bichim", article: "SKU: 165264270", processing: "Buyurtmani qayta ishlash 1–2 kun davom etadi", beforeNoon: "12:00 CET gacha berilgan buyurtmalar shu ish kunida yuboriladi", shipping: "Buyurtmalar UPS yer usti yetkazib berishi orqali jo'natiladi", returns: "Mahsulot xariddan keyin 30 kun ichida qaytarilishi mumkin", returnPolicy: "Qaytarish siyosati", close: "Yopish", remove: "Olib tashlash", selected: "Tanlangan", cartEmpty: "Savat bo‘sh", freeDeliveryRemaining: "Bepul yetkazib berishgacha", freeDeliveryReached: "Bepul yetkazib berish", cartSubtotalWithCount: "Oraliq jami ({count})", removePromo: "Olib tashlash", promoAccepted: "Promokod qabul qilindi", promoCode: "Kod", quickActions: "Tezkor amallar", mobileNavigation: "Mobil navigatsiya", email: "E-pochta" },
  ru: { ...common, shop: "Магазин", collections: "Коллекции", lookbook: "Лукбук", blog: "Блог", search: "Поиск", favorites: "Избранное", cart: "Корзина", profile: "Профиль", newCollection: "Новая коллекция", go: "Перейти", accessories: "Аксессуары", tactical: "Тактичные", records: "Записи", playlist: "Перейти в плейлист", readMore: "Читать дальше", customers: "Покупателю", contacts: "Контакты", payments: "Виды оплаты", delivery: "Доставка и оплата", exchange: "Обмен и возврат", sizeGuide: "Размерная сетка", support: "Поддержка", privacy: "Политика конфиденциальности", terms: "Пользовательское соглашение", language: "Язык", confirm: "Подтвердить", location: "Ташкент", sale: "Новые поступления со скидкой 20%", album: "Альбом: SIREN", articleTitle: "Нам нужно больше скейтеров", articleDate: "Пн, 22 дек. 2025", articleBody: "Марк Макгоуэн открыл для себя работы Шепарда Фейри 20 лет назад, когда впервые переехал из Англии в Америку. Его поразили противоречия, заложенные в американской культуре.", allProducts: "Все товары", home: "Главная", description: "Описание", notFound: "Товар не найден", name: "Название", color: "Цвет", size: "Размер", discountCode: "Скидочный код", enterCode: "Введите код", apply: "Применить", orderSummary: "Сводка заказа", subtotal: "Промежуточный итог", estimatedDelivery: "Предполагаемая доставка", total: "Общий", checkout: "ОФОРМИТЬ ЗАКАЗ", select: "Выбрать товар", unselect: "Убрать товар", decrease: "Уменьшить количество", increase: "Увеличить количество", chooseColor: "Выберите цвет", chooseSize: "Выберите размер", sizeHelp: "Какой у меня размер?", addToCart: "Добавить в корзину", goToCart: "Перейти в корзину", favoriteAdd: "Добавить в избранное", freeDelivery: "Бесплатная доставка при заказе от 2 000 000 СУМ", darkGray: "Тёмно-серый", black: "Чёрный", cream: "Кремовый", pink: "Розовый", gray: "Серый", classicTee: "Классическая футболка", graphicPrint: "Графический принт спереди и сзади", cotton: "100% хлопок", standardFit: "Стандартная посадка", article: "SKU: 165264270", processing: "Обработка заказа занимает 1–2 дня", beforeNoon: "Заказы, оформленные до 12:00 CET, отправляются в тот же рабочий день", shipping: "Заказы доставляются наземной службой UPS", returns: "Товар можно вернуть в течение 30 дней после покупки", returnPolicy: "Политика возврата", previous: "Предыдущее", next: "Следующее", back: "Назад", playTrack: "Воспроизвести трек", close: "Закрыть", remove: "Удалить", selected: "Выбрано", cartEmpty: "Корзина пуста", freeDeliveryRemaining: "До бесплатной доставки", freeDeliveryReached: "Бесплатная доставка", cartSubtotalWithCount: "Промежуточный итог ({count})", removePromo: "Убрать", promoAccepted: "Промокод принят", promoCode: "Код", quickActions: "Быстрые действия", mobileNavigation: "Мобильная навигация", email: "Эл. почта" },
  ja: { ...common, shop: "ショップ", collections: "コレクション", lookbook: "ルックブック", blog: "ブログ", search: "検索", favorites: "お気に入り", cart: "カート", profile: "プロフィール", newCollection: "新作コレクション", go: "見る", accessories: "アクセサリー", merch: "グッズ", tactical: "タクティカル", records: "レコード", playlist: "プレイリストへ", readMore: "続きを読む", customers: "お客様へ", contacts: "お問い合わせ", payments: "支払い方法", delivery: "配送と支払い", exchange: "交換・返品", sizeGuide: "サイズガイド", support: "サポート", privacy: "プライバシーポリシー", terms: "利用規約", language: "言語", confirm: "確認", location: "タシケント", sale: "新着商品 20%オフ", articleTitle: "もっとスケーターが必要", allProducts: "すべての商品", home: "ホーム", description: "説明", notFound: "商品が見つかりません", name: "商品名", color: "カラー", size: "サイズ", discountCode: "割引コード", enterCode: "コードを入力", apply: "適用", orderSummary: "注文内容", subtotal: "小計", estimatedDelivery: "配送料", total: "合計", checkout: "注文手続きへ", select: "商品を選択", unselect: "選択を解除", decrease: "数量を減らす", increase: "数量を増やす", chooseColor: "カラーを選択", chooseSize: "サイズを選択", sizeHelp: "サイズガイド", addToCart: "カートに追加", goToCart: "カートを見る", favoriteAdd: "お気に入りに追加", freeDelivery: "2,000,000 UZS以上のご注文は送料無料", darkGray: "ダークグレー", black: "ブラック", cream: "クリーム", pink: "ピンク", gray: "グレー", classicTee: "クラシックTシャツ", graphicPrint: "前後にグラフィックプリント", cotton: "綿100%", standardFit: "レギュラーフィット", article: "SKU: 165264270", processing: "注文処理には1〜2日かかります", beforeNoon: "12:00までのご注文は当営業日に発送します", shipping: "ご注文は配送サービスでお届けします", returns: "商品は購入後30日以内に返品できます", returnPolicy: "返品ポリシー", previous: "前へ", next: "次へ", back: "戻る", playTrack: "トラックを再生", close: "閉じる", remove: "削除", selected: "選択済み", cartEmpty: "カートは空です", freeDeliveryRemaining: "送料無料まで", freeDeliveryReached: "送料無料", cartSubtotalWithCount: "小計（{count}）", removePromo: "削除", promoAccepted: "プロモコードが適用されました", promoCode: "コード", quickActions: "クイック操作", mobileNavigation: "モバイルナビゲーション", email: "メール" },
...
Object.assign(translations.uz, {
  favoritesTitle: "SEVIMLILAR", favoritesEmpty: "Hali saqlangan mahsulotlar yo‘q", siteTesting: "SAYT TEST REJIMIDA",
});
Object.assign(translations.ru, {
  favoritesTitle: "ИЗБРАННОЕ", favoritesEmpty: "В избранном пока нет товаров", siteTesting: "САЙТ ТЕСТИРУЕТСЯ",
});
