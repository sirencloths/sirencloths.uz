...
export function Button({ children, className = "", variant = "default", size = "default", ...props }: ButtonProps) {
  const tone = variant === "default" ? "!bg-brand-500 !text-white hover:!bg-brand-600" : variant === "destructive" ? "!bg-error-500 !text-white hover:!bg-error-600" : variant === "outline" ? "!border-gray-300 !bg-white !text-gray-700 hover:!bg-gray-50 dark:!border-gray-700 dark:!bg-transparent dark:!text-gray-300" : "!bg-gray-100 !text-gray-700 hover:!bg-gray-200 dark:!bg-white/10 dark:!text-gray-200";
