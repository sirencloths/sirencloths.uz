...
@Module({
  imports: [TypeOrmModule.forFeature([Customer, CustomerAddress, Order, OrderItem, Product, ProductVariant, Partner, PartnerPromoUsage, AuditLog, PickupLocation]), TelegramModule],
